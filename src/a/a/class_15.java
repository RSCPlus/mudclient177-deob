...
public class class_15 {
   ...
   public class_15(String var1) {
      ...
      try {
         ...
         if(var22 || var24 < 3) {
            do {
               var24 += var6.read(var26, var24, 3 - var24);
            } while(var24 < 3);
         }
         ...
         if(!var22 && var24 >= var25) {
            ...
            while(true) {
               var24 += var6.read(var26, var24, var25 - var24);
               if(var24 >= var25) {
                  var6.close();
                  break;
               }
      ...
      if(!var22 && var16 >= var28) {
         ...
         do {
            ...
            int var11 = this.method_393(var26);
            int var12 = this.method_393(var26);
            int var13 = this.method_393(var26);
            this.field_933 = this.method_393(var26);
            this.field_934 = this.method_393(var26);
            int var29 = this.method_393(var26);
            int[] var17 = new int[var10];
            int var18 = 0;
            if(var22) {
               var17[var18] = this.method_393(var26);
               ++var18;
            }
            ...
            int var20 = 0;
            if(var22) {
               var19[var20] = this.method_393(var26);
               ++var20;
            }
            ...
            label37: {
               ...
               this.field_867[var21] = this.field_896;
            }
