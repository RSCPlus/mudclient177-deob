...
public class class_11 {
   ...
   public static boolean field_801;
   // $FF: renamed from: P int
   public static int field_802;
   // $FF: renamed from: Q int
         ...
         if(var7 || var5 < var1 + var3) {
            do {
               ...
               if(!var7 && var6 >= var2 + var4) {
                  ...
                  do {
                     this.field_761.method_244(var5, var6, 6 + field_802, 128);
                     var6 += 128;
   ...
   public int method_293(int var1, int var2, String var3, int var4, boolean var5) {
   ...
   public int method_294(int var1, int var2, int var3, int var4) {
   ...
   public int method_295(int var1, int var2, int var3, int var4) {
   ...
   public int method_296(int var1, int var2, int var3) {
   ...
   public int method_300(int var1, int var2, int var3, int var4, int var5, int var6, boolean var7) {
   ...
   public int method_301(int var1, int var2, int var3, int var4) {
